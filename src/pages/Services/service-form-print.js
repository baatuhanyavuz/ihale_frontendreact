...
const ServiceDetailsForm = ({ service }) => {
  document.title = "Servis Details | Velzon - React Admin & Dashboard Template";
  return (
                ...
                <div className="d-sm-flex">
                  ...
                  <div className="flex-shrink-0 mt-sm-0 mt-3">
                    ...
                    <h6>
                      ...
                      <span id="email">info@timforklift.com</span>
                    </h6>
                    <h6>
